...
//  Song-X
//
//  Created by Türker Kızılcık on 13.10.2024.
//
...
extension AVAudioUnitReverbPreset: CustomStringConvertible {
...
struct PlayerTime {
    ...
    private static func formatted(time: Double) -> String {
        ...
        var formattedString = ""
        if hours > 0 {
            formattedString = "\(String(format: "%01d", hours)):"
        }
...
enum DocumentType {
    ...
    var text: String {
        ...
        case .privacyPolicy:
            return """
                     Privacy Policy
                     Türker Kızılcık built the SongX app as a Freemium app. This SERVICE is provided by Türker Kızılcık at no cost with paid features and is intended for use as is.
                    
                     This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.
                    
                     If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.
                    
                     The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at SongX unless otherwise defined in this Privacy Policy.
        ...
        case .termsOfUse:
            ...
            The SongX app stores and processes personal data that you have provided to us, to provide my Service. It’s your responsibility to keep your phone and access to the app secure. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the SongX app won’t work properly or at all.
        
            You should be aware that there are certain things that SongX will not take responsibility for. Certain functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi or provided by your mobile network provider, but SongX cannot take responsibility for the app not working at full functionality if you don’t have access to Wi-Fi, and you don’t have any of your data allowance left.
            ...
            Along the same lines, SongX cannot always take responsibility for the way you use the app i.e. You need to make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the Service, Türker Kızılcık cannot accept responsibility.
